...
knownRawValues =
  ...
  errorObj: {"body":{"handle":10,"type":"error","className":"Error","constructorFunction":{"ref":93},"protoObject":{"ref":178},"prototypeObject":{"ref":3},"properties":[{"name":"code","propertyType":1,"ref":179},{"name":"message","attributes":2,"propertyType":1,"ref":180},{"name":"stack","attributes":2,"propertyType":3,"ref":3},{"name":"errno","propertyType":1,"ref":179},{"name":"syscall","propertyType":1,"ref":181},{"name":"type","attributes":2,"propertyType":1,"ref":3},{"name":"arguments","attributes":2,"propertyType":1,"ref":3}],"text":"Error: getaddrinfo ENOTFOUND"},"refs":[{"handle":93,"type":"function","className":"Function","constructorFunction":{"ref":50},"protoObject":{"ref":182},"prototypeObject":{"ref":178},"name":"Error","inferredName":"","resolved":true,"source":"function Error() { [native code] }","scopes":[],"properties":[{"name":"prototype","attributes":7,"propertyType":3,"ref":178},{"name":"caller","attributes":7,"propertyType":3,"ref":9},{"name":"stackTraceLimit","propertyType":1,"ref":100},{"name":"captureStackTrace","propertyType":2,"ref":183},{"name":"length","attributes":7,"propertyType":3,"ref":18},{"name":"prepareStackTrace","propertyType":1,"ref":3},{"name":"name","attributes":7,"propertyType":3,"ref":184},{"name":"arguments","attributes":7,"propertyType":3,"ref":9}],"text":"function Error() { [native code] }"},{"handle":178,"type":"error","className":"Error","constructorFunction":{"ref":93},"protoObject":{"ref":8},"prototypeObject":{"ref":3},"properties":[{"name":"toString","attributes":2,"propertyType":2,"ref":185},{"name":"message","attributes":2,"propertyType":1,"ref":186},{"name":"name","attributes":2,"propertyType":1,"ref":184},{"name":"constructor","attributes":2,"propertyType":2,"ref":93}],"text":"Error"},{"handle":3,"type":"undefined","text":"undefined"},{"handle":179,"type":"string","value":"ENOTFOUND","length":9,"text":"ENOTFOUND"},{"handle":180,"type":"string","value":"getaddrinfo ENOTFOUND","length":21,"text":"getaddrinfo ENOTFOUND"},{"handle":181,"type":"string","value":"getaddrinfo","length":11,"text":"getaddrinfo"}]}
...
describe 'debug-client', ->
  describe 'RemoteObject', ->
    ...
    withRawValue 'errorObj', DEFAULT_OPTIONS, (mapped) ->
      it 'has type object', -> expect(mapped.type).to.be 'object'
