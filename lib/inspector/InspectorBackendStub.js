...
InspectorBackendStub = function () {
  function InspectorBackendStub() {
    ...
    this._eventArgs['Network.responseReceived'] = [
      'requestId',
      'timestamp',
      'type',
      'response'
    ];
    this._eventArgs['Network.dataReceived'] = [
      'requestId',
      'timestamp',
      'dataLength',
      'encodedDataLength'
    ];
    this._eventArgs['Network.loadingFinished'] = [
      'requestId',
      'timestamp'
    ];
    this._eventArgs['Network.loadingFailed'] = [
      'requestId',
      'timestamp',
      'errorText',
      'canceled'
