...
var agents, debug, entryScript, fs, SocketChannel, socketChannel, wrapperObject;
fs = require('fs');
...
SocketChannel = function () {
  function SocketChannel(param$) {
    var cache$, instance$, this$, this$1, this$2;
    instance$ = this;
    ...
    this.socketConnection.on('message', (this$1 = this, function (data) {
      return this$1.handleRequest(JSON.parse(data.utf8Data));
    }));
    this.socketConnection.on('disconnect', (this$2 = this, function () {
      return this$2.socketConnection = null;
    }));
    this.syncBrowser();
  }
