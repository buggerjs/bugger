...
var _, agents, debug, detectLogLevel, entryScript, fs, knownLogLevels, knownLogLevelsToRegExp, level, logAndReturn, names, regexp, SocketChannel, socketChannel, wrapperObject;
fs = require('fs');
