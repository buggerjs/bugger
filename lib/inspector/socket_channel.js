...
var _, agents, debug, detectLogLevel, entryScript, fs, knownLogLevels, knownLogLevelsToRegExp, level, logAndReturn, names, path, regexp, SocketChannel, socketChannel, wrapperObject;
fs = require('fs');
path = require('path');
...
SocketChannel = function () {
  function SocketChannel(param$) {
    var cache$1, instance$, this$, this$1, this$2, this$3, this$4;
    instance$ = this;
