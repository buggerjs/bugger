...
var _, _renderHeaders, http, https, lastRequestId, load, makeStackTrace, mimeTypeToResponseType, patchProtocolLib, removeArraysFromHeaders, sendMessage, toTimeline, url;
http = require('http');
https = require('https');
url = require('url');
  ...
  return protocolLib.request = function (options, cb) {
    ...
    patchedClientRequest = function (cReq) {
      ...
      cReq.end = function () {
        ...
        toTimeline('ResourceSendRequest', {
    ...
    patchedClientResponseCallback = function (cb) {
      return function (cRes) {
        ...
        cRes.on('end', function () {
          ...
          return toTimeline('ResourceReceiveResponse', {
