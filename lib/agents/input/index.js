...
class InputAgent extends BaseAgent {
   ...
   * @param {GestureSourceType=} gestureSourceType Which type of input events to be generated (default: 'default', which queries the platform for the preferred input type).
   * @param {integer=} repeatCount The number of times to repeat the gesture (default: 0).
   * @param {integer=} repeatDelayMs The number of milliseconds delay between each repeat. (default: 250).
   * @param {string=} interactionMarkerName The name of the interaction markers to generate, if not empty (default: "").
   */
