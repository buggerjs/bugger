...
var _, _renderHeaders, _responseContentCache, lastRequestId, makeStackTrace, mimeTypeToResponseType, networkProbe, patchProtocol, Probe, protocol, removeArraysFromHeaders, sendMessage, url;
url = require('url');
