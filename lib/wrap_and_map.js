...
var _, expressionToHandle, handleToExpression, knownExpressions, knownExpressionsRev, lastHandle, logAndReturn, makePropertyHandle, refToObject, throwErr, toJSONValue, wrapperObject;
...
toJSONValue = function (objInfo, refs) {
  ...
  case 'object':
    ...
    objInfo.properties.forEach(function (prop) {
      var propObjInfo;
      propObjInfo = _.defaults({ handle: makePropertyHandle('_'+objInfo.handle, prop.name) }, refMap[prop.ref]);
