...
function createBugger(options) {
  ...
  function run(filename, args) {
    return withAgents(filename, args, options.debugBreak).then(setupServer);
  }
  ...
  function setupServer(agents) {
    ...
    var devtoolsBase = 'https://chrome-devtools-frontend.appspot.com/serve_rev/@198849/inspector.html';
