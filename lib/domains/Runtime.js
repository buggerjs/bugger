...
module.exports = function (param$) {
  ...
  Runtime.callFunctionOn = function (param$1, cb) {
    var additional_context, args, cache$, doNotPauseOnExceptionsAndMuteConsole, expression, functionDeclaration, generatePreview, objectId, params, returnByValue;
    {
      cache$ = param$1;
