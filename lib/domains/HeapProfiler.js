...
module.exports = function (param$) {
  ...
  HeapProfiler.enable = function (param$1, cb) {
    void 0;
    return cb(null, { result: true });
  };
  HeapProfiler.startTrackingHeapObjects = function (param$1, cb) {
    void 0;
    return cb();
  };
  HeapProfiler.stopTrackingHeapObjects = function (param$1, cb) {
    var reportProgress;
    reportProgress = param$1.reportProgress;
    return cb();
  };
