...
module.exports = function (agentContext) {
  ...
  Network.loadResourceForFrontend = function (param$, cb) {
    var cache$, frameId, requestHeaders, url;
    {
      cache$ = param$;
      frameId = cache$.frameId;
      url = cache$.url;
      requestHeaders = cache$.requestHeaders;
    }
    return Request(url, { headers: requestHeaders }, function (err, res, content) {
      if (null != err)
        return cb(err);
      return cb(null, {
        result: {
