...
module.exports = function (param$) {
  ...
  Debugger.enable = function (param$1, cb) {
    ...
    return debugClient.scripts({ includeSource: true }, function (err, scripts) {
      var script;
  ...
  Debugger.stepOver = function (param$1, cb) {
    void 0;
    return debugClient['continue']({ stepaction: 'next' }, function () {
  ...
  Debugger.stepInto = function (param$1, cb) {
    void 0;
    return debugClient['continue']({ stepaction: 'in' }, function () {
      Debugger.emit_resumed();
      return cb();
    });
  };
  Debugger.stepOut = function (param$1, cb) {
    void 0;
    return debugClient['continue']({ stepaction: 'out' }, function () {
      Debugger.emit_resumed();
      return cb();
    });
  };
  ...
  Debugger.resume = function (param$1, cb) {
    void 0;
    return debugClient['continue']({}, function () {
      Debugger.emit_resumed();
      return cb();
    });
  };
  ...
  Debugger.setPauseOnExceptions = function (param$1, cb) {
    ...
    tasks = [
      function (cb) {
        return debugClient.setexceptionbreak({
          type: 'all',
          enabled: state === 'all'
        });
      },
