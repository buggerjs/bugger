...
var _, agents, breakpoints, debug, expressionToHandle, handleToExpression, knownExpressions, knownExpressionsRev, languageMode, lastHandle, LOOKUP_TIMEOUT, prepareEvaluation, refToObject, throwErr, timelineInterval, toJSONValue, wrapperObject;
    ...
    start: function (param$, cb, channel) {
      ...
      if (!timelineInterval)
        timelineInterval = setInterval(function () {
          ...
          return channel.pushTimelineEvent('UpdateMemoryUsage', {
            usedHeapSize: Math.floor(Math.random() * 1e4),
