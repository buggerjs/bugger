...
var _, agents, breakpoints, debug, entryScript, expressionToHandle, handleToExpression, knownExpressions, knownExpressionsRev, languageMode, lastHandle, logAndReturn, LOOKUP_TIMEOUT, prepareEvaluation, refToObject, throwErr, timelineInterval, toJSONValue, wrapperObject;
...
agents = {
  ...
  Runtime: {
    evaluate: function (options, cb, channel) {
      var args, cache$, cmd, commandMode, doNotPauseOnExceptions, expression, includeCommandLineAPI, m, objectGroup, parseError, returnByValue;
      cache$ = options;
      expression = cache$.expression;
      objectGroup = cache$.objectGroup;
      includeCommandLineAPI = cache$.includeCommandLineAPI;
