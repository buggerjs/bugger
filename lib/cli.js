...
var argv, argvParser, bugger, buggerOptions, pick, script, scriptArgs, version;
argvParser = require('optimist').usage('bugger [OPTIONS] FILE_NAME').options({
  ...
  language: { describe: 'Force detection of entry script language. Supported: "js" and "coffee"' },
  probes: { describe: "Comma separated list of probes to enable, defaults to all of 'em" }
});
