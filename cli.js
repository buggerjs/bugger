...
(function() {
  ...
  run = function() {
    ...
    try {
      ...
      return forkScript(entryScript, debugPort, argv['debug-brk'], argv._, function(_arg) {
        var debugConnection, debugServer, entryScriptProc;
        entryScriptProc = _arg.entryScriptProc, debugConnection = _arg.debugConnection;
