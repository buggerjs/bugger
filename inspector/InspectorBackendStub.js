  ...
  InspectorBackendStub = (function() {
    ...
    function InspectorBackendStub() {
      ...
      this.agent('Debugger', function(a) {
        ...
        return a.ignore('setOverlayMessage');
      });
      ...
      this.agent('Timeline', function(a) {
        ...
        return a.ignore('setIncludeDomCounters');
      });
      this.agent('Page', function(a) {
        ...
        return a.ignore('getScriptExecutionStatus');
      });
      ...
      this.agent('Network', function(a) {
        ...
        return a.ignore('canClearBrowserCookies');
      });
    ...
    InspectorBackendStub.prototype.agent = function(agentId, withContext) {
      var agentName, ctx, _agent, _ref;
      agentName = "" + agentId + "Agent";
      _agent = (_ref = window[agentName]) != null ? _ref : window[agentName] = {};
      ctx = {
        ignore: function(functionName) {
          _agent[functionName] = function() {};
          return _agent[functionName].invoke = function(args, callback) {
    ...
    InspectorBackendStub.prototype.dispatch = function(message) {
      var args, callback, dispatcher, domainName, errObj, functionName, k, key, messageObject, paramName, paramNames, params, stringMessage, v, _i, _len, _ref;
      if (window.dumpInspectorProtocolMessages) {
      ...
      if ((messageObject.id != null) > 0) {
        ...
        args = (function() {
          ...
          if (messageObject.result) {
            ...
            for (key in messageObject.result) {
              _results.push(messageObject.result[key]);
            }
            return _results;
          } else {
            return [];
        ...
        _ref = messageObject.method.split("."), domainName = _ref[0], functionName = _ref[1];
        if (this._domainDispatchers[domainName] == null) {
        ...
        if (dispatcher[functionName] == null) {
    ...
    InspectorBackendStub.prototype.runAfterPendingDispatches = function(script) {
      ...
      if (!this._pendingResponsesCount) {
        ...
        for (_i = 0, _len = scripts.length; _i < _len; _i++) {
          script = scripts[_i];
          _results.push(script.call(this));
        }
        return _results;
      }
    };
