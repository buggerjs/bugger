...
class InspectorBackendStub
  constructor: ->
    ...
    ;this._registerDelegate('{"method": "Debugger.evaluateOnCallFrame", "params": {"callFrameId": {"optional": false, "type": "string"},"expression": {"optional": false, "type": "string"},"objectGroup": {"optional": true , "type": "string"},"includeCommandLineAPI": {"optional": true , "type": "boolean"}, "doNotPauseOnExceptionsAndMuteConsole": {"optional":true,"type":"boolean"},"returnByValue": {"optional": true , "type": "boolean"},"generatePreview": {"optional": true , "type": "boolean"}}, "id": 0}');
    ...
    this._eventArgs["Debugger.scriptParsed"] = ["scriptId","url","startLine","startColumn","endLine","endColumn","isContentScript","sourceMapURL","hasSourceURL"];
      ...
      if messageObject.id? > 0 # just a response for some request
        ...
        unless @_domainDispatchers[domainName]?
          return console.error(
              "Protocol Error: the message is for non-existing domain '#{domainName}'")
